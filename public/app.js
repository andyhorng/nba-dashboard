...
var _user$project$Main$log = function (r) {
	var _p0 = r;
	if (_p0.ctor === 'Ok') {
		return r;
	} else {
		return A2(_elm_lang$core$Debug$log, _p0._0, r);
	}
};
var _user$project$Main$apply = _elm_lang$core$Json_Decode$object2(
	F2(
		function (x, y) {
			return x(y);
		}));
var _user$project$Main$constructing = _elm_lang$core$Json_Decode$succeed;
var _user$project$Main$historyView = F2(
	function (current, history) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('tooltip-item')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
											...
											return A2(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html_Attributes$class('num')
															]),
														_elm_lang$core$Native_List.fromArray(
															[
...
var _user$project$Main$translateTeamName = function (raw) {
	...
	var key = last(
		_elm_lang$core$Array$fromList(
			A2(
				...
				' ',
				_elm_lang$core$String$toLower(raw))));
	var _p3 = key;
	if (_p3.ctor === 'Nothing') {
		return 'Unknown';
	} else {
...
var _user$project$Main$translateSource = function (source) {
	var _p5 = source;
	switch (_p5) {
		case 'twsport':
			return '台彩';
...
var _user$project$Main$formatDate = function (orig) {
	var _p6 = _elm_lang$core$Date$fromString(orig);
	if (_p6.ctor === 'Ok') {
		var twdate = _elm_lang$core$Date$fromTime(
			_elm_lang$core$Date$toTime(_p6._0) + ((8 * 60) * 60));
		return _elm_lang$core$Maybe$Just(
			A2(_mgold$elm_date_format$Date_Format$format, '%Y/%m/%d %H:%M', twdate));
	} else {
		return A2(_elm_lang$core$Debug$log, _p6._0, _elm_lang$core$Maybe$Nothing);
	}
};
var _user$project$Main$competitionInfo = function (row) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('competition-info')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Main$translateTeamName(row.teamA))
					])),
				A2(
				_elm_lang$html$Html$span,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('vs')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('v.s.')
					])),
				A2(
				_elm_lang$html$Html$span,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_user$project$Main$translateTeamName(row.teamB))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						function () {
							var _p7 = _user$project$Main$formatDate(row.time);
							if (_p7.ctor === 'Just') {
								return _p7._0;
							} else {
								return '';
...
var _user$project$Main$totalRow = function (row) {
	var sort = _elm_lang$core$List$sortBy(_elm_lang$core$Basics$fst);
	var mapper = F2(
		function (getter, odd) {
			var _p8 = odd;
			if (_p8.ctor === 'Total') {
				...
				return A2(
					...
					_user$project$Main$formatDate(_p9.createdAt),
					function (date) {
						return _elm_lang$core$Maybe$Just(
							{
								ctor: '_Tuple2',
	...
	var showOdd = function (_p10) {
		var _p11 = _p10;
		var _p15 = _p11._1;
		var odd = _elm_lang$core$List$head(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text(
												_user$project$Main$translateSource(_p11._0)),
												A2(
												_elm_lang$html$Html$span,
												_elm_lang$core$Native_List.fromArray(
													[]),
										...
										_elm_lang$core$Native_List.fromArray(
											[
												A2(
												_user$project$Main$historyView,
												_p14.score,
												A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$competitionInfo(row),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('odd')
					]),
				A2(
					_elm_lang$core$List$filterMap,
					showOdd,
					_elm_lang$core$Dict$toList(row.odds)))
			]));
};
var _user$project$Main$spreadRow = function (row) {
	var showOdd = function (_p16) {
		...
		var mapper = F2(
			function (getter, odd) {
				...
				if (_p18.ctor === 'Spread') {
					...
					return A2(
						_elm_lang$core$Maybe$andThen,
						_user$project$Main$formatDate(_p19.createdAt),
						function (date) {
							return _elm_lang$core$Maybe$Just(
								{
									ctor: '_Tuple2',
		...
		var getter = F3(
			function (getter1, getter2, oddRecord) {
				return A2(
		...
		var latest = _elm_lang$core$List$head(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text(
												_user$project$Main$translateSource(_p17._0)),
												A2(
												_elm_lang$html$Html$span,
												_elm_lang$core$Native_List.fromArray(
													[]),
...
var _user$project$Main$moneyLineRow = function (row) {
		...
		var mapper = F2(
			function (getter, odd) {
				...
				if (_p26.ctor === 'MoneyLine') {
					...
					return A2(
						_elm_lang$core$Maybe$andThen,
						_user$project$Main$formatDate(_p27.createdAt),
						function (date) {
							return _elm_lang$core$Maybe$Just(
								{
									ctor: '_Tuple2',
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text(
												_user$project$Main$translateSource(_p25._0)),
												A2(
												_elm_lang$html$Html$span,
												_elm_lang$core$Native_List.fromArray(
													[]),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('type')
					]),
				A2(
					_elm_lang$core$List_ops['::'],
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('大小分')
							])),
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$totalRow,
						_elm_lang$core$Dict$values(model.total)))),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$spreadRow,
						_elm_lang$core$Dict$values(model.spread)))),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				A2(
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('不讓分')
							])),
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$moneyLineRow,
						_elm_lang$core$Dict$values(model.moneyLine))))
			]));
};
var _user$project$Main$initialModel = {total: _elm_lang$core$Dict$empty, spread: _elm_lang$core$Dict$empty, moneyLine: _elm_lang$core$Dict$empty};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$addBet = F2(
	function (bet, model) {
		var updateRow = function (dict) {
			var _p31 = A2(_elm_lang$core$Dict$get, bet.competitionToken, dict);
			if (_p31.ctor === 'Just') {
				var _p33 = _p31._0;
				var oldOdds = A2(_elm_lang$core$Dict$get, bet.source, _p33.odds);
				var _p32 = oldOdds;
				if (_p32.ctor === 'Just') {
					return _elm_lang$core$Native_Utils.update(
						_p33,
			...
			case 'total':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						total: A3(
							_elm_lang$core$Dict$insert,
							bet.competitionToken,
							updateRow(model.total),
							model.total)
					});
			case 'spread':
				return _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		if (_p35.ctor === 'NoOp') {
			...
			return {
				ctor: '_Tuple2',
				_0: A2(_user$project$Main$addBet, _p35._0, model),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$Main$Bet = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {oddType: a, teamA: b, teamB: c, time: d, league: e, region: f, sport: g, source: h, competitionToken: i, createdAt: j, odd: k};
										};
									};
								};
							};
...
var _user$project$Main$TotalOdd = F4(
	function (a, b, c, d) {
		return {score: a, oddUnder: b, oddOver: c, createdAt: d};
	});
var _user$project$Main$SpreadOdd = F5(
	function (a, b, c, d, e) {
		return {scoreA: a, scoreB: b, oddA: c, oddB: d, createdAt: e};
	});
var _user$project$Main$MoneyLineOdd = F3(
	function (a, b, c) {
		return {oddA: a, oddB: b, createdAt: c};
	});
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {total: a, spread: b, moneyLine: c};
	});
var _user$project$Main$Competition = F8(
	function (a, b, c, d, e, f, g, h) {
		return {competitionToken: a, teamA: b, teamB: c, time: d, league: e, region: f, sport: g, odds: h};
	});
var _user$project$Main$Unknown = {ctor: 'Unknown'};
var _user$project$Main$emptyBet = {teamA: '', teamB: '', oddType: '', time: '', league: '', region: '', sport: '', source: '', competitionToken: '', createdAt: '', odd: _user$project$Main$Unknown};
var _user$project$Main$MoneyLine = function (a) {
	return {ctor: 'MoneyLine', _0: a};
};
var _user$project$Main$Spread = function (a) {
	return {ctor: 'Spread', _0: a};
};
var _user$project$Main$Total = function (a) {
	return {ctor: 'Total', _0: a};
};
var _user$project$Main$oddDecoder = F2(
	function (oddType, date) {
		var _p36 = oddType;
		switch (_p36) {
			case 'total':
				return A2(
					...
					A5(
						...
						_user$project$Main$TotalOdd,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'score', _elm_lang$core$Json_Decode$string),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'odd_under', _elm_lang$core$Json_Decode$string),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'odd_over', _elm_lang$core$Json_Decode$string),
						_elm_lang$core$Json_Decode$succeed(date)));
			case 'spread':
				return A2(
					_elm_lang$core$Json_Decode$map,
					_user$project$Main$Spread,
					A6(
						_elm_lang$core$Json_Decode$object5,
						_user$project$Main$SpreadOdd,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'score_a', _elm_lang$core$Json_Decode$string),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'score_b', _elm_lang$core$Json_Decode$string),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'odd_a', _elm_lang$core$Json_Decode$string),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'odd_b', _elm_lang$core$Json_Decode$string),
						_elm_lang$core$Json_Decode$succeed(date)));
			case 'money_line':
				return A2(
					_elm_lang$core$Json_Decode$map,
					_user$project$Main$MoneyLine,
					A4(
						_elm_lang$core$Json_Decode$object3,
						_user$project$Main$MoneyLineOdd,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'odd_a', _elm_lang$core$Json_Decode$string),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'odd_b', _elm_lang$core$Json_Decode$string),
						_elm_lang$core$Json_Decode$succeed(date)));
			default:
				return _elm_lang$core$Json_Decode$fail('Unknow odd type');
		}
	});
var _user$project$Main$betDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'odd_type', _elm_lang$core$Json_Decode$string),
	function (s) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			A2(
			...
			function (date) {
				return A2(
											...
											A2(
												...
												A2(
													...
													A2(
														...
														A2(
															_user$project$Main$apply,
															_user$project$Main$constructing(_user$project$Main$Bet),
															A2(_elm_lang$core$Json_Decode_ops[':='], 'odd_type', _elm_lang$core$Json_Decode$string)),
														A2(_elm_lang$core$Json_Decode_ops[':='], 'team_a', _elm_lang$core$Json_Decode$string)),
													A2(_elm_lang$core$Json_Decode_ops[':='], 'team_b', _elm_lang$core$Json_Decode$string)),
												A2(_elm_lang$core$Json_Decode_ops[':='], 'time', _elm_lang$core$Json_Decode$string)),
											A2(_elm_lang$core$Json_Decode_ops[':='], 'league', _elm_lang$core$Json_Decode$string)),
										A2(_elm_lang$core$Json_Decode_ops[':='], 'region', _elm_lang$core$Json_Decode$string)),
									A2(_elm_lang$core$Json_Decode_ops[':='], 'sport', _elm_lang$core$Json_Decode$string)),
								A2(_elm_lang$core$Json_Decode_ops[':='], 'source', _elm_lang$core$Json_Decode$string)),
							A2(_elm_lang$core$Json_Decode_ops[':='], 'competition_token', _elm_lang$core$Json_Decode$string)),
						A2(
							_elm_lang$core$Json_Decode$at,
							_elm_lang$core$Native_List.fromArray(
								['meta', 'created_at']),
					...
					A2(
						...
						'odd',
						A2(_user$project$Main$oddDecoder, s, date)));
			});
	});
