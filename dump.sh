...
docker exec -i site_python_1 pip install rethinkdb==1.16.0-3
docker cp ./dump-data.tar.gz site_python_1:/
docker exec -i site_python_1 rethinkdb-restore /dump-data.tar.gz -c rethinkdb-driver --force
